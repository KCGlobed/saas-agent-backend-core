...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (e && (t = e(e = 0)), t), s = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), c = (e, i, o, s) => {
	...
	b = /* @__PURE__ */ l(d()), x = y(), ee = (e) => {
		...
		let v = e.primaryColor || "#6366f1", y = async (t) => {
			...
			try {
				let r = await (await fetch("http://localhost:4000/api/chat/generate", {
					method: "POST",
					headers: { "Content-Type": "application/json" },
					body: JSON.stringify({
						projectId: e.projectId,
	...
	te();
	var t = y(), n = async () => {
		let n = document.getElementById("chat-widget-root");
		if (!n) return;
		let r = n.getAttribute("data-project-id");
		if (!r) {
		...
		try {
			let e = await fetch(`http://localhost:4000/api/widget/${r}/config`);
			if (e.ok) {
				let t = await e.json();
				i = {
					...i,
		...
		a.id = "sass-agentic-chat-widget-container", document.body.appendChild(a), (0, e.createRoot)(a).render(/* @__PURE__ */ (0, t.jsx)(C, { config: i }));
	};
