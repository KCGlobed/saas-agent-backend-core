...
var e = Object.create, t = Object.defineProperty, n = Object.getOwnPropertyDescriptor, r = Object.getOwnPropertyNames, i = Object.getPrototypeOf, a = Object.prototype.hasOwnProperty, o = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), s = (e, i, o, s) => {
	...
	let n = t.slice(1, -1);
	return /[-:]+/.test(n) ? /^[\s|:-]+$/.test(t) : !1;
}, S = (e) => e.trim().split("|").map((e) => e.trim()).filter((e, t, n) => t > 0 && t < n.length - 1), C = (e) => {
	let t = e.replace(/\|\s*\r?\n\s*\r?\n\s*\|/g, "|\n|").split("\n"), n = [], r = 0;
	for (; r < t.length;) {
		let e = t[r];
		if (e.trim() === "") {
		...
		if (e.trim() === "---" || e.trim() === "***" || e.trim() === "___") {
			n.push(/* @__PURE__ */ (0, x.jsx)("hr", { style: {
				border: "none",
		...
		if (i.startsWith("|") && i.endsWith("|")) {
			let i = r + 1 < t.length ? t[r + 1] : "", a = i && ee(i), o = i.trim(), s = o.startsWith("|") && o.endsWith("|") && !ee(i);
			if (a || s) {
				let i = S(e), o = r + 1;
				a && (o += 1);
				let s = [];
				...
				if (i.length > 0 && s.length > 0) {
					n.push(/* @__PURE__ */ (0, x.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, x.jsxs)("table", {
							...
							children: [/* @__PURE__ */ (0, x.jsx)("thead", { children: /* @__PURE__ */ (0, x.jsx)("tr", {
							...
							}) }), /* @__PURE__ */ (0, x.jsx)("tbody", { children: s.map((e, t) => /* @__PURE__ */ (0, x.jsx)("tr", {
								style: {
									borderBottom: t === s.length - 1 ? "none" : "1px solid #f3f4f6",
									background: t % 2 == 1 ? "#fafafa" : "transparent",
								...
								onMouseOut: (e) => {
									e.currentTarget.style.backgroundColor = t % 2 == 1 ? "#fafafa" : "transparent";
								},
								children: i.map((t, n) => /* @__PURE__ */ (0, x.jsx)("td", {
									style: {
										padding: "8px 10px",
										color: "#4b5563",
										maxWidth: "200px",
		...
		if (e.match(/^\d+\.\s/)) {
			let e = [];
			for (; r < t.length && t[r].match(/^\d+\.\s/);) {
				let n = t[r].match(/^\d+\.\s(.*)$/);
				e.push(/* @__PURE__ */ (0, x.jsx)("li", {
					style: { marginBottom: "2px" },
					children: te(n ? n[1] : t[r])
				}, r)), r++;
			}
			n.push(/* @__PURE__ */ (0, x.jsx)("ol", {
				style: {
					paddingLeft: "18px",
					margin: "4px 0 8px 0",
	...
	let v = e.primaryColor || "#6366f1", y = async (t) => {
		...
		try {
			let r = await (await fetch(`${re}/chat/generate`, {
				method: "POST",
				headers: { "Content-Type": "application/json" },
				body: JSON.stringify({
					projectId: e.projectId,
			...
			u ? /* @__PURE__ */ (0, x.jsxs)(x.Fragment, { children: [/* @__PURE__ */ (0, x.jsxs)("div", {
				...
				children: [
					...
					r.map((e, t) => /* @__PURE__ */ (0, x.jsxs)("div", {
						...
						children: [e.role === "assistant" && /* @__PURE__ */ (0, x.jsx)("div", {
							...
							style: {
								maxWidth: e.role === "assistant" ? "96%" : "82%",
							...
							}) : /* @__PURE__ */ (0, x.jsx)("div", { children: C(e.content) })
						})]
					}, t)),
				...
				children: [/* @__PURE__ */ (0, x.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, x.jsx)("input", {
						...
						onKeyDown: (e) => e.key === "Enter" && !e.shiftKey && ee(),
						disabled: s
					}), /* @__PURE__ */ (0, x.jsx)("button", {
						onClick: ee,
						disabled: s || !a.trim(),
...
}, re = "http://localhost:4000/api";
if (document.currentScript && document.currentScript.src) try {
	re = `${new URL(document.currentScript.src).origin}/api`;
} catch (e) {
...
var w = async () => {
	...
	try {
		let e = await fetch(`${re}/widget/${t}/config`);
		if (e.ok) {
			let t = await e.json();
			n = {
				...n,
	...
	r.id = "sass-agentic-chat-widget-container", document.body.appendChild(r), (0, y.createRoot)(r).render(/* @__PURE__ */ (0, x.jsx)(ne, { config: n }));
};
document.readyState === "complete" || document.readyState === "interactive" ? w() : document.addEventListener("DOMContentLoaded", w);
//#endregion
export { re as API_BASE_URL };
